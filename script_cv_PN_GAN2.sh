                                    ...
                                    do
                                        ...
                                        do
                                            python3 /home/cclin/few_shot_learning/sem_hal/train_fsl_infer_PN.py \
                                                ...
                                                --hallucinator_name HAL_PN_m${m_support}n${n_support}a${n_aug}q${n_query}_ite${n_ite_per_epoch}_GAN2 \
                                                --data_path None \
                                                --sim_set_path None \
                                                --n_fine_classes 25 \
                                                --n_shot $((n_shot)) \
                                        ...
                                        rm -rf /home/cclin/few_shot_learning/sem_hal/awa/results_cv/HAL_PN_m${m_support}n${n_support}a${n_aug}q${n_query}_ite${n_ite_per_epoch}_GAN2/FSL*
                                    done
                                done
                            done
                        done
