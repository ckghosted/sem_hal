                                    ...
                                    do
                                        ...
                                        do
                                            python3 /home/cclin/few_shot_learning/hallucination_by_analogy/train_fsl_infer_PN.py \
                                                ...
                                                --hallucinator_name HAL_PN_fc256_m${m_support}n${n_support}a${n_aug}q${n_query}_ite${n_ite_per_epoch}_GAN2_256 \
                                                --data_path None \
                                                --sim_set_path None \
                                                --n_fine_classes 25 \
                                                --n_shot $((n_shot)) \
                                        ...
                                        rm -rf /home/cclin/few_shot_learning/hallucination_by_analogy/_for_awa/results_final_$1/HAL_PN_fc256_m${m_support}n${n_support}a${n_aug}q${n_query}_ite${n_ite_per_epoch}_GAN2_256/FSL*
                                    done
                                done
                            done
                        done
